...
print("KNN: ")
print("Tocnost train: ".format((accuracy_score(y_train, y_train_p_KNN))))
print("Tocnost test: ".format((accuracy_score(y_test, y_test_p_KNN))))

plot_decision_regions(X_train_n, y_train, classifier=KNN_model)
plt.xlabel('x_1')
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("Tocnost: ".format((accuracy_score(y_train, y_train_p_KNN))))
plt.tight_layout()
plt.show()
...
print("SVM: ")
print("Tocnost train: ".format((accuracy_score(y_train, y_train_p_SVM))))
print("Tocnost test: ".format((accuracy_score(y_test, y_test_p_SVM))))

plot_decision_regions(X_train_n, y_train, classifier=SVM_model)
plt.xlabel('x_1')
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("Tocnost: ".format((accuracy_score(y_train, y_train_p_SVM))))
plt.tight_layout()
plt.show()
